         ...
         children: <Widget>[
           Container(
             ...
             child: Column(
               ...
               children: <Widget>[
                 ...
                 Text(suggestionList[index]['state'],style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),)
               ]
             )
           ),
           Expanded(child: Container(
             ...
             child: Column(
               mainAxisAlignment: MainAxisAlignment.center,
               children:<Widget>[
                 Text('CONFIRMED:' + suggestionList[index]['confirmed'].toString(),style: TextStyle(fontWeight: FontWeight.bold,color: Colors.red),),
                 ...
                 Text('DEATHS:' + suggestionList[index]['deaths'].toString(),style: TextStyle(fontWeight: FontWeight.bold,color: Theme.of(context).brightness==Brightness.light?Colors.grey[100]:Colors.grey[900]),),
               ]
             ),
           ),)
         ]
